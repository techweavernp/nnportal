...
<div class="share-buttons">
    ...
    <button class="share-btn twitter" wire:click="trackShare"
    ...
    <button class="share-btn whatsapp" wire:click="trackShare"
    ...
    <button class="share-btn messenger" wire:click="trackShare"
